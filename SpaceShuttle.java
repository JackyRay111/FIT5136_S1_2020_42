...
public class SpaceShuttle
{
     ...
     * Constructor for objects of class spaceShuttle
     */
    public SpaceShuttle(String newShuttleName, String newShuttleOrigin, int newManufacturingYear, int newFuelCapacity, int newPassengerCapacity, int newCargoCapacity, int newTravelSpeed, int newShuttleId)
    {
        // initialise attributes
     ...
     */
    public String getShuttleOrigin(){
     ...
     *          shuttle origin
     */
    public void setShuttleOrigin(String newShuttleOrigin){
        shuttleOrigin = newShuttleOrigin;
    }
    ...
    public void displayShuttleInfo() {
        System.out.println("");
        System.out.println("* Shuttle ID: " + getShuttleId());
        System.out.println("1.Shuttle Name: " + getShuttleName());
        System.out.println("2.Country Of Origin: " + getShuttleOrigin());
        System.out.println("3.Manufacturing Year: " + getManufacturingYear());
        System.out.println("4.Passenger Capacity: " + getPassengerCapacity());
        System.out.println("5.Fuel Capacity: " + getFuelCapacity());
        System.out.println("6.Travel Speed: " + getTravelSpeed());
        System.out.println("7.Cargo Capacity: " + getCargoCapacity());
    }
}
